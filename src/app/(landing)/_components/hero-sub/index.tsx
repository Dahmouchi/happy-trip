    ...
    return (
        <>
            <section className=" text-center bg-center  relative bg-gradient-to-b from-white from-10% dark:from-darkmode bg-cover  to-[#83CD20] to-90% dark:to-darklight overflow-x-hidden" style={{backgroundImage:"url(/images/subHero.jpg)"}}>
                  <div className="w-full h-full text-white bg-black/20 bg-opacity-50  py-8 shadow-lg backdrop-blur-xs max-sm:px-8">
                ...
                <p className="lg:text-md text-sm text-gray-50 font-normal max-w-2xl w-full mx-auto mt-7 lg:mb-4 mb-6 sm:px-0 px-4">
                    {description}
                </p>
