...
>
  ...
  <div className="p-6">
    ...
    <div className="relative">
      <p className="text-gray-600 mb-5 line-clamp-1 transition-all duration-300">
    ...
    <div className="flex items-center justify-between pt-2 border-t border-gray-100">
      <div className="flex items-center">
        ...
        />
        <div>
          <p className="text-sm font-medium text-gray-800">HappyTrip Staff</p>
  ...
  return (
    <div className="bg-blue-50 rounded-xl p-6 md:p-8 my-12">
      <div className="text-center mb-6">
        ...
        <p className="text-gray-600">Get the latest articles and news delivered to your inbox</p>
      </div>
...
const BlogPage = ({ blogs: initialBlogs}:any) => {
 ...
 console.log("ini",initialBlogs)
  ...
  const paginatedBlogs = filteredBlogs.slice(1).slice(0, page * blogsPerPage);
    ...
    <div className="bg-gray-50 min-h-screen font-sans">
      <div className="container mx-auto  pb-12">
        ...
        <HeroSub
            ...
            />
            <div className='flex items-center justify-end px-4 py-2  bg-[#83CD20]'><SearchBar searchQuery={searchQuery} setSearchQuery={setSearchQuery} /></div>

        {/* Search Bar */}
        <div className='lg:px-8 pt-4'>
        {/* Blog Grid */}
