      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          ...
          <CardContent className="pt-6">
            <div className="space-y-8">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder="Entrez le lieu du circuit"
                            {...field}
                            value={field.value || ""}
                          />
                        </FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          URL de l&apos;image principale pour ce circuit
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                        ...
                        <div className="space-y-1 leading-none">
                          ...
                          <FormDescription>
                            Cochez ceci si le circuit est disponible uniquement
                            les week-ends
                          </FormDescription>
                        </div>
                      </FormItem>
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Définissez les détails du groupe pour le circuit.
                </p>
                <Separator className="mb-6" />
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input
                              placeholder="ex: Petit groupe, Famille"
                              {...field}
                              value={field.value || ""}
                            />
                          </FormControl>
                          <FormDescription>
                            Décrivez le type de groupe pour lequel ce circuit
                            est conçu
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input
                              type="number"
                              placeholder="Entrez la taille maximale du groupe"
                              {...field}
                            />
                          </FormControl>
                          <FormMessage />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder="Entrez les détails de l'hébergement"
                            {...field}
                            value={field.value || ""}
                          />
                        </FormControl>
                        <FormDescription>
                          Décrivez l&apos;hébergement fourni pendant le circuit
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Sélectionnez les styles de vacances qui s&apos;appliquent à ce
                  circuit.
                </p>
                <Separator className="mb-6" />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          Sélectionnez tous les styles de vacances qui
                          s&apos;appliquent à ce circuit
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
        ...
        <div className="flex justify-end">
          <Button
            type="submit"
            size="lg"
            className="bg-[#6EC207] text-white hover:bg-[#5BA906] hover:cursor-pointer"
          >
            Créer le circuit
          </Button>
        </div>
